  ...
  return (
    <section id="certifications" className="relative py-20 md:py-28 bg-[#FFFBEB] dark:bg-[#1A1A14] border-b-4 border-black transition-colors duration-200 overflow-hidden">
      ...
      <div className="absolute top-[35%] right-[5%] hidden lg:block select-none z-0 transform rotate-12">
        <svg className="w-20 h-20 text-[#FFEB3B] fill-current stroke-black stroke-[3px] filter drop-shadow-[3px_3px_0_rgba(0,0,0,1)]" viewBox="0 0 100 100">
      ...
      <div className="absolute bottom-[20%] left-[5%] hidden lg:block select-none z-0 transform rotate-[-8deg]">
        <svg className="w-16 h-16 text-[#FF5252] fill-current stroke-black stroke-[3px] filter drop-shadow-[2.5px_2.5px_0_rgba(0,0,0,1)]" viewBox="0 0 100 100">
      ...
      <div className="absolute top-6 left-[18%] hidden lg:block select-none z-0 animate-rotate-slow">
        <svg className="w-14 h-14 text-[#4ECDC4] fill-current stroke-black stroke-[3px] filter drop-shadow-[2.5px_2.5px_0_rgba(0,0,0,1)]" viewBox="0 0 100 100">
      ...
      <div className="absolute bottom-10 right-[25%] hidden md:block select-none z-0 transform rotate-12">
        <svg className="w-24 h-6 text-[#2196F3] stroke-black stroke-[3px] fill-none" viewBox="0 0 100 25">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-3.5 mb-10">
              <div className="w-12 h-12 bg-[#2196F3] text-white border-2 border-black flex items-center justify-center transform rotate-[-2deg] shrink-0">
            ...
            <div className="max-h-[380px] overflow-y-auto pr-3 space-y-4 nb-scrollbar pb-2">
              {portfolio.certifications.map((cert, index) => (
                <div 
                  key={index} 
                  className="bg-white dark:bg-[#1E1E1E] nb-card-static p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transform hover:rotate-[0.5deg] transition-transform duration-200"
                >
                  <div>
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-3.5 mb-10">
              <div className="w-12 h-12 bg-[#FF5252] text-white border-2 border-black flex items-center justify-center transform rotate-[3deg] shrink-0">
            ...
            <div className="max-h-[380px] overflow-y-auto pr-3 space-y-4 nb-scrollbar pb-2">
              {portfolio.achievements.map((item, index) => (
                <div 
                  key={index} 
                  className="bg-white dark:bg-[#1E1E1E] nb-card-static p-6 transform hover:rotate-[-0.5deg] transition-transform duration-200"
                >
